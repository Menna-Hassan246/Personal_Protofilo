...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="relative w-10 h-10 rounded-full bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 hover:border-primary/40 hover:scale-110 transition-all duration-300"
    >
